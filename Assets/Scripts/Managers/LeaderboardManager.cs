...
public class LeaderboardManager : MonoBehaviour
{
    private void Awake()
    {
        if (AppManager.leaderboardManager == null || AppManager.leaderboardManager != this)
        {
            AppManager.leaderboardManager = this;
        }
    }
    ...
    public List<PlayerInfoDisplay> slots = new List<PlayerInfoDisplay>();
    ...
    public void Init()
    {
        ...
        IsReady = true;
        Debug.Log("<color=green> Leaderboard is ready! </color>");
    }
