...
public class GameTimerOld : MonoBehaviour {
	...
	void Update () {
		if(timerStarted) {
            ...
            if(countUp) {
                ...
                if(timer > timerDuration/* TrinaxGlobal.Instance.gameSettings.gameDuration*/) {
                    timer = timerDuration/*TrinaxGlobal.Instance.gameSettings.gameDuration*/;
                    if (timesUp != null) {
    ...
    public timeResult getTimeResult() {
        ...
        float remainingTime = timerDuration/*TrinaxGlobal.Instance.gameSettings.gameDuration*/ - timer;
