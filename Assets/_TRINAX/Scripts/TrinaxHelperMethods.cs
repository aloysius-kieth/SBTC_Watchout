...
public static class TrinaxHelperMethods
{
    ...
    /// <summary>
    /// To Round to by 0.5, multiply by 2 divide by 2
    /// 0.25  = 4
    /// 
    /// </summary>
    ...
    /// <returns></returns>
    public static float RoundToNearestMidPoint(float valueToRound, int multipleOf)
    {
        valueToRound = valueToRound * multipleOf;
        valueToRound = Mathf.Round(valueToRound);
        valueToRound = valueToRound / multipleOf;
        return valueToRound;
    }
